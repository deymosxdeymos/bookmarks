	...
	return (
		<>
			<div className="orchestration">
				<header
					className="fixed top-0 left-0 right-0 z-20 bg-background"
					style={
						{ "--stagger": 0 } as React.CSSProperties & { "--stagger": number }
					}
				>
			...
			<div className="bg-background font-sans min-h-screen max-w-xl flex items-center justify-center p-8 pt-20 mx-auto">
				<main className="flex flex-col w-full">
					<div className="space-y-6 orchestration">
						<div
							className="flex flex-col gap-2"
							style={
								{ "--stagger": 0 } as React.CSSProperties & {
									"--stagger": number;
								}
							}
						>
							...
							<p className="text-md text-muted-foreground font-light text-justify">
								...
								hyperlinks. You should probably be using something else, though.
							</p>
						</div>
						<div
							className="flex flex-col gap-2"
						...
						<div
							className="flex flex-col gap-2"
							style={
								{ "--stagger": 2 } as React.CSSProperties & {
									"--stagger": number;
								}
							}
						>
						...
						<Separator
							style={
								{ "--stagger": 3 } as React.CSSProperties & {
									"--stagger": number;
								}
							}
						/>
						<footer
							...
							style={
								{ "--stagger": 4 } as React.CSSProperties & {
									"--stagger": number;
								}
							}
						>
